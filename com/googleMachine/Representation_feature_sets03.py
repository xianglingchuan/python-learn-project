...
def preprocess_targets(california_housing_dataframe):
  ...
  #解决报错添加行
  output_targets["median_income"] = california_housing_dataframe["median_income"];
...
#print ("======= training_examples[median_income] =======");
#print (training_examples['median_income']);


#print ("======= training_targets[median_income] =======");
#print (training_targets['median_income']);

#print ("======= median_income 2 =======");
#print (validation_examples['median_income']);
...
def train_model(
    ...
    training_input_fn = lambda: my_input_fn(training_examples,
                                            training_targets["median_income"],
                                            batch_size=batch_size)

    print ("======== training_input_fn =========");
    print (training_input_fn);
    #<function train_model.<locals>.<lambda> at 0x1c2e19f620>
    #<function train_model.<locals>.<lambda> at 0x1c26336378>
    ...
    predict_validation_input_fn = lambda: my_input_fn(validation_examples,
                                                      validation_targets["median_income"],
                                                      num_epochs=1,
                                                      shuffle=False)
...
#selected_training_examples = training_examples + selected_training_examples;
